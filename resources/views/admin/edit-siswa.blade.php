                    ...
                    <form action="/siswa/{{ $user->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" name="noinduk_siswa" class="form-control @error('noinduk_siswa') is-invalid @enderror" id="noinduk_siswa"
                                placeholder="Nama" value="{{ old('noinduk_siswa', $user->noinduk_siswa) }}">
                            @error('noinduk_siswa')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>    
                        ...
                        <div class="form-group">
                            <input type="text" name="email_sekolah" class="form-control @error('email_sekolah') is-invalid @enderror" id="email_sekolah"
                                placeholder="Email Sekolah" value="{{ old('email_sekolah', $user->email_sekolah) }}">
                            @error('email_sekolah')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>    
                        ...
                        <div class="form-group">
                            <input type="text" name="alamat_sekolah" class="form-control @error('alamat_sekolah') is-invalid @enderror" id="alamat_sekolah"
                                placeholder="Alamat Sekolah" value="{{ old('alamat_sekolah', $user->alamat_sekolah) }}">
                        ...
                        <div class="form-group">
                            <input type="noinduk_guru" name="noinduk_guru" class="form-control @error('noinduk_guru') is-invalid @enderror" id="noinduk_guru"
                                placeholder="No Guru" value="{{ old('noinduk_guru', $user->noinduk_guru) }}">
                            @error('noinduk_guru')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>    
                        ...
                        <div class="form-group">
                            <input type="telepon_sekolah" name="telepon_sekolah" class="form-control @error('telepon_sekolah') is-invalid @enderror" id="telepon_sekolah"
                                placeholder="Telepon sekolah" value="{{ old('telepon_sekolah', $user->telepon_sekolah) }}">
